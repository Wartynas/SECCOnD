...
PERCENT_OF_EDGES_TO_REWIRE <- 1 # - try 1, 5, 10 and 20.
...
NMI_hmap_vanilla_1perc <- matrix(NA, nrow = length(NU_WITHIN), ncol = length(NU_BETWEEN))
NMI_hmap_calibrated_1perc <- matrix(NA, nrow = length(NU_WITHIN), ncol = length(NU_BETWEEN))
NMI_hmap_consensus_1perc <- matrix(NA, nrow = length(NU_WITHIN), ncol = length(NU_BETWEEN))

NMI_sd_hmap_vanilla_1perc <- matrix(NA, nrow = length(NU_WITHIN), ncol = length(NU_BETWEEN))
NMI_sd_hmap_calibrated_1perc <- matrix(NA, nrow = length(NU_WITHIN), ncol = length(NU_BETWEEN))
NMI_sd_hmap_consensus_1perc <- matrix(NA, nrow = length(NU_WITHIN), ncol = length(NU_BETWEEN))

nc_hmap_vanilla_1perc <- matrix(NA, nrow = length(NU_WITHIN), ncol = length(NU_BETWEEN))
nc_hmap_calibrated_1perc <- matrix(NA, nrow = length(NU_WITHIN), ncol = length(NU_BETWEEN))
nc_hmap_consensus_1perc <- matrix(NA, nrow = length(NU_WITHIN), ncol = length(NU_BETWEEN))
...
for(n in 1:length(NU_WITHIN)) {
  for(m in 1:length(NU_BETWEEN)) {
    ...
    if (check_if_community_structure_is_likely(PK, nu_with, nu_betw) < 1) {
      ...
      NMI_hmap_vanilla_1perc[n,m] <- mean(gathered_output[,1])
      NMI_hmap_calibrated_1perc[n,m] <- mean(gathered_output[,3])
      NMI_hmap_consensus_1perc[n,m] <- mean(gathered_output[,5])
      
      NMI_sd_hmap_vanilla_1perc[n,m] <- sd(gathered_output[,1])
      NMI_sd_hmap_calibrated_1perc[n,m] <- sd(gathered_output[,3])
      NMI_sd_hmap_consensus_1perc[n,m] <- sd(gathered_output[,5])
      
      nc_hmap_vanilla_1perc[n,m] <- getmode(gathered_output[,2])
      nc_hmap_calibrated_1perc[n,m] <- getmode(gathered_output[,4])
      nc_hmap_consensus_1perc[n,m] <- getmode(gathered_output[,6])
      
      saveRDS(NMI_hmap_vanilla_1perc, "/rds/general/user/mv321/home/thesis/intermediate_NMI_hmap_vanilla_1perc.rds")
      saveRDS(NMI_hmap_calibrated_1perc, "/rds/general/user/mv321/home/thesis/intermediate_NMI_hmap_calibrated_1perc.rds")
      saveRDS(NMI_hmap_consensus_1perc, "/rds/general/user/mv321/home/thesis/intermediate_NMI_hmap_consensus_1perc.rds")
      
      saveRDS(NMI_sd_hmap_vanilla_1perc, "/rds/general/user/mv321/home/thesis/intermediate_NMI_sd_hmap_vanilla_1perc.rds")
      saveRDS(NMI_sd_hmap_calibrated_1perc, "/rds/general/user/mv321/home/thesis/intermediate_NMI_sd_hmap_calibrated_1perc.rds")
      saveRDS(NMI_sd_hmap_consensus_1perc, "/rds/general/user/mv321/home/thesis/intermediate_NMI_sd_hmap_consensus_1perc.rds")
      
      saveRDS(nc_hmap_vanilla_1perc, "/rds/general/user/mv321/home/thesis/intermediate_nc_hmap_vanilla_1perc.rds")
      saveRDS(nc_hmap_calibrated_1perc, "/rds/general/user/mv321/home/thesis/intermediate_nc_hmap_calibrated_1perc.rds")
      saveRDS(nc_hmap_consensus_1perc, "/rds/general/user/mv321/home/thesis/intermediate_nc_hmap_consensus_1perc.rds")
    }
  }
}

saveRDS(NMI_hmap_vanilla_1perc, "/rds/general/user/mv321/home/thesis/NMI_hmap_vanilla_1perc.rds")
saveRDS(NMI_hmap_calibrated_1perc, "/rds/general/user/mv321/home/thesis/NMI_hmap_calibrated_1perc.rds")
saveRDS(NMI_hmap_consensus_1perc, "/rds/general/user/mv321/home/thesis/NMI_hmap_consensus_1perc.rds")

saveRDS(NMI_sd_hmap_vanilla_1perc, "/rds/general/user/mv321/home/thesis/NMI_sd_hmap_vanilla_1perc.rds")
saveRDS(NMI_sd_hmap_calibrated_1perc, "/rds/general/user/mv321/home/thesis/NMI_sd_hmap_calibrated_1perc.rds")
saveRDS(NMI_sd_hmap_consensus_1perc, "/rds/general/user/mv321/home/thesis/NMI_sd_hmap_consensus_1perc.rds")

saveRDS(nc_hmap_vanilla_1perc, "/rds/general/user/mv321/home/thesis/nc_hmap_vanilla_1perc.rds")
saveRDS(nc_hmap_calibrated_1perc, "/rds/general/user/mv321/home/thesis/nc_hmap_calibrated_1perc.rds")
saveRDS(nc_hmap_consensus_1perc, "/rds/general/user/mv321/home/thesis/nc_hmap_consensus_1perc.rds")
