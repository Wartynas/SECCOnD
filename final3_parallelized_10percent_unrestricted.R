...
NMI_hmap_vanilla_10perc <- array(NA, dim = c(length(NU_WITHIN), length(NU_BETWEEN), NUM_OF_REALISATIONS))
NMI_hmap_calibrated_10perc <- array(NA, dim = c(length(NU_WITHIN), length(NU_BETWEEN), NUM_OF_REALISATIONS))
NMI_hmap_consensus_10perc <- array(NA, dim = c(length(NU_WITHIN), length(NU_BETWEEN), NUM_OF_REALISATIONS))

NMI_sd_hmap_vanilla_10perc <- array(NA, dim = c(length(NU_WITHIN), length(NU_BETWEEN), NUM_OF_REALISATIONS))
NMI_sd_hmap_calibrated_10perc <- array(NA, dim = c(length(NU_WITHIN), length(NU_BETWEEN), NUM_OF_REALISATIONS))
NMI_sd_hmap_consensus_10perc <- array(NA, dim = c(length(NU_WITHIN), length(NU_BETWEEN), NUM_OF_REALISATIONS))

nc_hmap_vanilla_10perc <- array(NA, dim = c(length(NU_WITHIN), length(NU_BETWEEN), NUM_OF_REALISATIONS))
nc_hmap_calibrated_10perc <- array(NA, dim = c(length(NU_WITHIN), length(NU_BETWEEN), NUM_OF_REALISATIONS))
nc_hmap_consensus_10perc <- array(NA, dim = c(length(NU_WITHIN), length(NU_BETWEEN), NUM_OF_REALISATIONS))
...
for(n in 1:length(NU_WITHIN)) {
  for(m in 1:length(NU_BETWEEN)) {
    ...
    NMI_hmap_vanilla_10perc[n,m,] <- gathered_output[,1]
    NMI_hmap_calibrated_10perc[n,m,] <- gathered_output[,3]
    NMI_hmap_consensus_10perc[n,m,] <- gathered_output[,5]
    
    nc_hmap_vanilla_10perc[n,m,] <- gathered_output[,2]
    nc_hmap_calibrated_10perc[n,m,] <- gathered_output[,4]
    nc_hmap_consensus_10perc[n,m,] <- gathered_output[,6]
    
    resolution_matrix[n,m,] <- gathered_output[,7]
    
    saveRDS(NMI_hmap_vanilla_10perc, "/rds/general/user/mv321/home/thesis/step_1_10percent_unrestricted_3D_output/intermediate_NMI_hmap_vanilla_10perc.rds")
    saveRDS(NMI_hmap_calibrated_10perc, "/rds/general/user/mv321/home/thesis/step_1_10percent_unrestricted_3D_output/intermediate_NMI_hmap_calibrated_10perc.rds")
    saveRDS(NMI_hmap_consensus_10perc, "/rds/general/user/mv321/home/thesis/step_1_10percent_unrestricted_3D_output/intermediate_NMI_hmap_consensus_10perc.rds")
    
    saveRDS(nc_hmap_vanilla_10perc, "/rds/general/user/mv321/home/thesis/step_1_10percent_unrestricted_3D_output/intermediate_nc_hmap_vanilla_10perc.rds")
    saveRDS(nc_hmap_calibrated_10perc, "/rds/general/user/mv321/home/thesis/step_1_10percent_unrestricted_3D_output/intermediate_nc_hmap_calibrated_10perc.rds")
    saveRDS(nc_hmap_consensus_10perc, "/rds/general/user/mv321/home/thesis/step_1_10percent_unrestricted_3D_output/intermediate_nc_hmap_consensus_10perc.rds")
    
    saveRDS(resolution_matrix, "/rds/general/user/mv321/home/thesis/step_1_10percent_unrestricted_3D_output/intermediate_resolution_matrix_10perc.rds")
    # }
  }
}

saveRDS(NMI_hmap_vanilla_10perc, "/rds/general/user/mv321/home/thesis/step_1_10percent_unrestricted_3D_output/NMI_hmap_vanilla_10perc.rds")
saveRDS(NMI_hmap_calibrated_10perc, "/rds/general/user/mv321/home/thesis/step_1_10percent_unrestricted_3D_output/NMI_hmap_calibrated_10perc.rds")
saveRDS(NMI_hmap_consensus_10perc, "/rds/general/user/mv321/home/thesis/step_1_10percent_unrestricted_3D_output/NMI_hmap_consensus_10perc.rds")

saveRDS(nc_hmap_vanilla_10perc, "/rds/general/user/mv321/home/thesis/step_1_10percent_unrestricted_3D_output/nc_hmap_vanilla_10perc.rds")
saveRDS(nc_hmap_calibrated_10perc, "/rds/general/user/mv321/home/thesis/step_1_10percent_unrestricted_3D_output/nc_hmap_calibrated_10perc.rds")
saveRDS(nc_hmap_consensus_10perc, "/rds/general/user/mv321/home/thesis/step_1_10percent_unrestricted_3D_output/nc_hmap_consensus_10perc.rds")

saveRDS(resolution_matrix, "/rds/general/user/mv321/home/thesis/step_1_10percent_unrestricted_3D_output/resolution_matrix_10perc.rds")
